...
func (s *HTTPServer) StartServer() error{
	...
	router.Path("/tasks").Methods("POST").HandleFunc(s.httpHandlers.HandleCreateTask)
	...
	router.Path("/tasks/{title}").Methods("PATCH").HandlerFunc(s.httpHandlers.HandleCompleteTasks)
